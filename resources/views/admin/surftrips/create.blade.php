<x-backlayout>
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-8 mb-8">
        <h1 class="text-3xl font-extrabold text-gray-900 mb-8 text-center">Create New Surf Trip</h1>
        ...
        <form action="{{ route('admin.surftrips.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @include('admin.surftrips.form', ['surftrip' => null])
